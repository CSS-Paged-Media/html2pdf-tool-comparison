...
<div class="details-boxes">
    ...
    <div>
        ...
        <img src="/{{ page.path }}/../itextpdfhtml__html_Vendor_Samples_WeasyPrint_invoice.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
            <a href="/{{ page.path }}/../itextpdfhtml__html_Vendor_Samples_WeasyPrint_invoice.html.pdf" target="_blank">📕 pdfHTML (iText 7 add-on) Output</a>
        </p>
    </div>
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_Vendor_Samples_WeasyPrint_invoice.html.png" alt="Flying Saucer Preview" />
        <p>
            <a href="/{{ page.path }}/../flyingsaucer__html_Vendor_Samples_WeasyPrint_invoice.html.pdf" target="_blank">📕 Flying Saucer Output</a>
        </p>
    </div>
</div>
...
<div class="details-boxes">
    ...
    <div>
        <h4>pdfHTML (iText 7 add-on)</h4>
        <img src="/{{ page.path }}/../itextpdfhtml__html_Vendor_Samples_WeasyPrint_report.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
            <a href="/{{ page.path }}/../itextpdfhtml__html_Vendor_Samples_WeasyPrint_report.html.pdf" target="_blank">📕 pdfHTML (iText 7 add-on) Output</a>
        </p>
    </div>
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_Vendor_Samples_WeasyPrint_report.html.png" alt="Flying Saucer Preview" />
        <p>
            <a href="/{{ page.path }}/../flyingsaucer__html_Vendor_Samples_WeasyPrint_report.html.pdf" target="_blank">📕 Flying Saucer Output</a>
        </p>
    </div>
</div>
...
<div class="details-boxes">
    ...
    <div>
        <h4>pdfHTML (iText 7 add-on)</h4>
        <img src="/{{ page.path }}/../itextpdfhtml__html_Vendor_Samples_WeasyPrint_ticket.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
            <a href="/{{ page.path }}/../itextpdfhtml__html_Vendor_Samples_WeasyPrint_ticket.html.pdf" target="_blank">📕 pdfHTML (iText 7 add-on) Output</a>
        </p>
    </div>
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_Vendor_Samples_WeasyPrint_ticket.html.png" alt="Flying Saucer Preview" />
        <p>
            <a href="/{{ page.path }}/../flyingsaucer__html_Vendor_Samples_WeasyPrint_ticket.html.pdf" target="_blank">📕 Flying Saucer Output</a>
        </p>
    </div>
</div>
