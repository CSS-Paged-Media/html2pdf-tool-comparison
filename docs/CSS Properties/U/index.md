...
<details>
    <summary>
        View UNICODE-BIDI Browser Output
    </summary>
    <img src="/{{ page.path }}/../browser_screenshot__html_CSS_Properties_U_unicode-bidi.html.pdf.png" />
    <p>
...
<details>
    <summary>
        View USER-SELECT Browser Output
    </summary>
    <img src="/{{ page.path }}/../browser_screenshot__html_CSS_Properties_U_user-select.html.pdf.png" />
    <p>
