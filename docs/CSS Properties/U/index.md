...
<div class="details-boxes">
    ...
    <div>
        ...
        <img src="/{{ page.path }}/../itextpdfhtml__html_CSS_Properties_U_unicode-bidi.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
    ...
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_CSS_Properties_U_unicode-bidi.html.png" alt="Flying Saucer Preview" />
        <p>
...
<div class="details-boxes">
    ...
    <div>
        <h4>pdfHTML (iText 7 add-on)</h4>
        <img src="/{{ page.path }}/../itextpdfhtml__html_CSS_Properties_U_user-select.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
    ...
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_CSS_Properties_U_user-select.html.png" alt="Flying Saucer Preview" />
        <p>
