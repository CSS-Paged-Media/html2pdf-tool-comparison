...
<details>
    <summary>
        View Z-INDEX Browser Output
    </summary>
    <img src="/{{ page.path }}/../browser_screenshot__html_CSS_Properties_Z_z-index.html.pdf.png" />
    <p>
...
<details>
    <summary>
        View ZOOM Browser Output
    </summary>
    <img src="/{{ page.path }}/../browser_screenshot__html_CSS_Properties_Z_zoom.html.pdf.png" />
    <p>
