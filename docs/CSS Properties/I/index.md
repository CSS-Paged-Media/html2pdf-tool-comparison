...
<div class="details-boxes">
    ...
    <div>
        ...
        <p>
            <a href="/{{ page.path }}/../openhtmltopdf__html_CSS_Properties_I_image-rendering.html.pdf" target="_blank">📕 openhtmltopdf Output</a>
        </p>
    </div>
    <div>
        ...
        <p>
            <a href="/{{ page.path }}/../itextpdfhtml__html_CSS_Properties_I_image-rendering.html.pdf" target="_blank">📕 pdfHTML (iText 7 add-on) Output</a>
        </p>
    </div>
    <div>
        <h4>Flying Saucer</h4>
        ...
        <p>
            <a href="/{{ page.path }}/../flyingsaucer__html_CSS_Properties_I_image-rendering.html.pdf" target="_blank">📕 Flying Saucer Output</a>
        </p>
    </div>
</div>
...
<div class="details-boxes">
    ...
    <div>
        ...
        <p>
            <a href="/{{ page.path }}/../openhtmltopdf__html_CSS_Properties_I_initial-letter.html.pdf" target="_blank">📕 openhtmltopdf Output</a>
        </p>
    </div>
    <div>
        <h4>pdfHTML (iText 7 add-on)</h4>
        ...
        <p>
            <a href="/{{ page.path }}/../itextpdfhtml__html_CSS_Properties_I_initial-letter.html.pdf" target="_blank">📕 pdfHTML (iText 7 add-on) Output</a>
        </p>
    </div>
    <div>
        <h4>Flying Saucer</h4>
        ...
        <p>
            <a href="/{{ page.path }}/../flyingsaucer__html_CSS_Properties_I_initial-letter.html.pdf" target="_blank">📕 Flying Saucer Output</a>
        </p>
    </div>
</div>
...
<div class="details-boxes">
    ...
    <div>
        ...
        <p>
            <a href="/{{ page.path }}/../openhtmltopdf__html_CSS_Properties_I_isolation.html.pdf" target="_blank">📕 openhtmltopdf Output</a>
        </p>
    </div>
    <div>
        <h4>pdfHTML (iText 7 add-on)</h4>
        ...
        <p>
            <a href="/{{ page.path }}/../itextpdfhtml__html_CSS_Properties_I_isolation.html.pdf" target="_blank">📕 pdfHTML (iText 7 add-on) Output</a>
        </p>
    </div>
    <div>
        <h4>Flying Saucer</h4>
        ...
        <p>
            <a href="/{{ page.path }}/../flyingsaucer__html_CSS_Properties_I_isolation.html.pdf" target="_blank">📕 Flying Saucer Output</a>
        </p>
    </div>
</div>
