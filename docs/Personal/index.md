...
<details>
    <summary>
        View BLOG-POST Browser Output
    </summary>
    <img src="/{{ page.path }}/../browser_screenshot__html_Personal_blog-post.html.pdf.png" />
    <p>
...
<details>
    <summary>
        View COLOR-PALETTE Browser Output
    </summary>
    <img src="/{{ page.path }}/../browser_screenshot__html_Personal_color-palette.html.pdf.png" />
    <p>
