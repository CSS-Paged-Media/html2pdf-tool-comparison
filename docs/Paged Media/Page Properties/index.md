...
<div class="details-boxes">
    ...
    <div>
        <h4>openhtmltopdf</h4>
        <img src="/{{ page.path }}/../openhtmltopdf__html_Paged_Media_Page_Properties_counter-even-numbered.html.png" alt="openhtmltopdf Preview" />
        <p>
    ...
    <div>
        ...
        <img src="/{{ page.path }}/../itextpdfhtml__html_Paged_Media_Page_Properties_counter-even-numbered.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
    ...
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_Paged_Media_Page_Properties_counter-even-numbered.html.png" alt="Flying Saucer Preview" />
        <p>
...
<div class="details-boxes">
    ...
    <div>
        <h4>openhtmltopdf</h4>
        <img src="/{{ page.path }}/../openhtmltopdf__html_Paged_Media_Page_Properties_counter-increment.html.png" alt="openhtmltopdf Preview" />
        <p>
    ...
    <div>
        <h4>pdfHTML (iText 7 add-on)</h4>
        <img src="/{{ page.path }}/../itextpdfhtml__html_Paged_Media_Page_Properties_counter-increment.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
    ...
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_Paged_Media_Page_Properties_counter-increment.html.png" alt="Flying Saucer Preview" />
        <p>
...
<div class="details-boxes">
    ...
    <div>
        <h4>openhtmltopdf</h4>
        <img src="/{{ page.path }}/../openhtmltopdf__html_Paged_Media_Page_Properties_counter-reset.html.png" alt="openhtmltopdf Preview" />
        <p>
    ...
    <div>
        <h4>pdfHTML (iText 7 add-on)</h4>
        <img src="/{{ page.path }}/../itextpdfhtml__html_Paged_Media_Page_Properties_counter-reset.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
    ...
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_Paged_Media_Page_Properties_counter-reset.html.png" alt="Flying Saucer Preview" />
        <p>
...
<div class="details-boxes">
    ...
    <div>
        <h4>openhtmltopdf</h4>
        <img src="/{{ page.path }}/../openhtmltopdf__html_Paged_Media_Page_Properties_counter.html.png" alt="openhtmltopdf Preview" />
        <p>
    ...
    <div>
        <h4>pdfHTML (iText 7 add-on)</h4>
        <img src="/{{ page.path }}/../itextpdfhtml__html_Paged_Media_Page_Properties_counter.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
    ...
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_Paged_Media_Page_Properties_counter.html.png" alt="Flying Saucer Preview" />
        <p>
