...
<div class="details-boxes">
    ...
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_M_marker.html.png" alt="Flying Saucer Preview" />
        <p>
            <a href="/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_M_marker.html.pdf" target="_blank">📕 Flying Saucer Output</a>
        </p>
    </div>
</div>
...
<div class="details-boxes">
    ...
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_M_matches.html.png" alt="Flying Saucer Preview" />
        <p>
            <a href="/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_M_matches.html.pdf" target="_blank">📕 Flying Saucer Output</a>
        </p>
    </div>
</div>
