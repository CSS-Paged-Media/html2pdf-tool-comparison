...
<div class="details-boxes">
    ...
    <div>
        ...
        <img src="/{{ page.path }}/../itextpdfhtml__html_CSS_Selectors_G_general-sibling.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
    ...
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_G_general-sibling.html.png" alt="Flying Saucer Preview" />
        <p>
