...
<div class="browser-mockup with-url">
    <div>
        <img src="/{{ page.path }}/../browser_screenshot__html_CSS_Selectors_I_id.html.pdf.png" alt="Browser Preview of ID" />
    </div>
</div>
<p>
...
<div class="details-boxes">
    <div>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../mpdf__html_CSS_Selectors_I_id.html.pdf" target="_blank">📕 mPDF Output</a>
        </p>
    </div>
    <div>
        <h4>typeset.sh</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../typeset__html_CSS_Selectors_I_id.html.pdf" target="_blank">📕 typeset Output</a>
        </p>
    </div>
    <div>
        <h4>PDFreactor</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../pdfreactor__html_CSS_Selectors_I_id.html.pdf" target="_blank">📕 PDFreactor Output</a>
        </p>
    </div>
    <div>
        <h4>wkhtmltopdf</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../wkhtmltopdf__html_CSS_Selectors_I_id.html.pdf" target="_blank">📕 wkhtmltopdf Output</a>
        </p>
    </div>
    <div>
        <h4>WeasyPrint</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../weasyprint__html_CSS_Selectors_I_id.html.pdf" target="_blank">📕 WeasyPrint Output</a>
        </p>
    </div>
    <div>
        <h4>Prince</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../princexml__html_CSS_Selectors_I_id.html.pdf" target="_blank">📕 Prince Output</a>
        </p>
    </div>
    <div>
        <h4>Puppeteer</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../puppeteer__html_CSS_Selectors_I_id.html.pdf" target="_blank">📕 Puppeteer Output</a>
        </p>
    </div>
    <div>
        <h4>openhtmltopdf</h4>
        <img src="/{{ page.path }}/../openhtmltopdf__html_CSS_Selectors_I_id.html.png" alt="openhtmltopdf Preview" />
        <p>
            <a href="/html2pdf/{{ page.path }}/../openhtmltopdf__html_CSS_Selectors_I_id.html.pdf" target="_blank">📕 openhtmltopdf Output</a>
        </p>
    </div>
    <div>
        <h4>pdfHTML (iText 7 add-on)</h4>
        <img src="/{{ page.path }}/../itextpdfhtml__html_CSS_Selectors_I_id.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
            <a href="/html2pdf/{{ page.path }}/../itextpdfhtml__html_CSS_Selectors_I_id.html.pdf" target="_blank">📕 pdfHTML (iText 7 add-on) Output</a>
        </p>
    </div>
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_I_id.html.png" alt="Flying Saucer Preview" />
        <p>
            <a href="/html2pdf/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_I_id.html.pdf" target="_blank">📕 Flying Saucer Output</a>
        </p>
    </div>
</div>
...
<div class="browser-mockup with-url">
    <div>
        <img src="/{{ page.path }}/../browser_screenshot__html_CSS_Selectors_I_in-range.html.pdf.png" alt="Browser Preview of IN-RANGE" />
    </div>
</div>
<p>
...
<div class="details-boxes">
    <div>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../mpdf__html_CSS_Selectors_I_in-range.html.pdf" target="_blank">📕 mPDF Output</a>
        </p>
    </div>
    <div>
        <h4>typeset.sh</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../typeset__html_CSS_Selectors_I_in-range.html.pdf" target="_blank">📕 typeset Output</a>
        </p>
    </div>
    <div>
        <h4>PDFreactor</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../pdfreactor__html_CSS_Selectors_I_in-range.html.pdf" target="_blank">📕 PDFreactor Output</a>
        </p>
    </div>
    <div>
        <h4>wkhtmltopdf</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../wkhtmltopdf__html_CSS_Selectors_I_in-range.html.pdf" target="_blank">📕 wkhtmltopdf Output</a>
        </p>
    </div>
    <div>
        <h4>WeasyPrint</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../weasyprint__html_CSS_Selectors_I_in-range.html.pdf" target="_blank">📕 WeasyPrint Output</a>
        </p>
    </div>
    <div>
        <h4>Prince</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../princexml__html_CSS_Selectors_I_in-range.html.pdf" target="_blank">📕 Prince Output</a>
        </p>
    </div>
    <div>
        <h4>Puppeteer</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../puppeteer__html_CSS_Selectors_I_in-range.html.pdf" target="_blank">📕 Puppeteer Output</a>
        </p>
    </div>
    <div>
        <h4>openhtmltopdf</h4>
        <img src="/{{ page.path }}/../openhtmltopdf__html_CSS_Selectors_I_in-range.html.png" alt="openhtmltopdf Preview" />
        <p>
            <a href="/html2pdf/{{ page.path }}/../openhtmltopdf__html_CSS_Selectors_I_in-range.html.pdf" target="_blank">📕 openhtmltopdf Output</a>
        </p>
    </div>
    <div>
        <h4>pdfHTML (iText 7 add-on)</h4>
        <img src="/{{ page.path }}/../itextpdfhtml__html_CSS_Selectors_I_in-range.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
            <a href="/html2pdf/{{ page.path }}/../itextpdfhtml__html_CSS_Selectors_I_in-range.html.pdf" target="_blank">📕 pdfHTML (iText 7 add-on) Output</a>
        </p>
    </div>
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_I_in-range.html.png" alt="Flying Saucer Preview" />
        <p>
            <a href="/html2pdf/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_I_in-range.html.pdf" target="_blank">📕 Flying Saucer Output</a>
        </p>
    </div>
</div>
...
<div class="browser-mockup with-url">
    <div>
        <img src="/{{ page.path }}/../browser_screenshot__html_CSS_Selectors_I_invalid.html.pdf.png" alt="Browser Preview of INVALID" />
    </div>
</div>
<p>
...
<div class="details-boxes">
    <div>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../mpdf__html_CSS_Selectors_I_invalid.html.pdf" target="_blank">📕 mPDF Output</a>
        </p>
    </div>
    <div>
        <h4>typeset.sh</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../typeset__html_CSS_Selectors_I_invalid.html.pdf" target="_blank">📕 typeset Output</a>
        </p>
    </div>
    <div>
        <h4>PDFreactor</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../pdfreactor__html_CSS_Selectors_I_invalid.html.pdf" target="_blank">📕 PDFreactor Output</a>
        </p>
    </div>
    <div>
        <h4>wkhtmltopdf</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../wkhtmltopdf__html_CSS_Selectors_I_invalid.html.pdf" target="_blank">📕 wkhtmltopdf Output</a>
        </p>
    </div>
    <div>
        <h4>WeasyPrint</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../weasyprint__html_CSS_Selectors_I_invalid.html.pdf" target="_blank">📕 WeasyPrint Output</a>
        </p>
    </div>
    <div>
        <h4>Prince</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../princexml__html_CSS_Selectors_I_invalid.html.pdf" target="_blank">📕 Prince Output</a>
        </p>
    </div>
    <div>
        <h4>Puppeteer</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../puppeteer__html_CSS_Selectors_I_invalid.html.pdf" target="_blank">📕 Puppeteer Output</a>
        </p>
    </div>
    <div>
        <h4>openhtmltopdf</h4>
        <img src="/{{ page.path }}/../openhtmltopdf__html_CSS_Selectors_I_invalid.html.png" alt="openhtmltopdf Preview" />
        <p>
            <a href="/html2pdf/{{ page.path }}/../openhtmltopdf__html_CSS_Selectors_I_invalid.html.pdf" target="_blank">📕 openhtmltopdf Output</a>
        </p>
    </div>
    <div>
        <h4>pdfHTML (iText 7 add-on)</h4>
        <img src="/{{ page.path }}/../itextpdfhtml__html_CSS_Selectors_I_invalid.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
            <a href="/html2pdf/{{ page.path }}/../itextpdfhtml__html_CSS_Selectors_I_invalid.html.pdf" target="_blank">📕 pdfHTML (iText 7 add-on) Output</a>
        </p>
    </div>
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_I_invalid.html.png" alt="Flying Saucer Preview" />
        <p>
            <a href="/html2pdf/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_I_invalid.html.pdf" target="_blank">📕 Flying Saucer Output</a>
        </p>
    </div>
</div>
...
<div class="browser-mockup with-url">
    <div>
        <img src="/{{ page.path }}/../browser_screenshot__html_CSS_Selectors_I_is.html.pdf.png" alt="Browser Preview of IS" />
    </div>
</div>
<p>
...
<div class="details-boxes">
    <div>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../mpdf__html_CSS_Selectors_I_is.html.pdf" target="_blank">📕 mPDF Output</a>
        </p>
    </div>
    <div>
        <h4>typeset.sh</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../typeset__html_CSS_Selectors_I_is.html.pdf" target="_blank">📕 typeset Output</a>
        </p>
    </div>
    <div>
        <h4>PDFreactor</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../pdfreactor__html_CSS_Selectors_I_is.html.pdf" target="_blank">📕 PDFreactor Output</a>
        </p>
    </div>
    <div>
        <h4>wkhtmltopdf</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../wkhtmltopdf__html_CSS_Selectors_I_is.html.pdf" target="_blank">📕 wkhtmltopdf Output</a>
        </p>
    </div>
    <div>
        <h4>WeasyPrint</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../weasyprint__html_CSS_Selectors_I_is.html.pdf" target="_blank">📕 WeasyPrint Output</a>
        </p>
    </div>
    <div>
        <h4>Prince</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../princexml__html_CSS_Selectors_I_is.html.pdf" target="_blank">📕 Prince Output</a>
        </p>
    </div>
    <div>
        <h4>Puppeteer</h4>
        ...
        <p>
            <a href="/html2pdf/{{ page.path }}/../puppeteer__html_CSS_Selectors_I_is.html.pdf" target="_blank">📕 Puppeteer Output</a>
        </p>
    </div>
    <div>
        <h4>openhtmltopdf</h4>
        <img src="/{{ page.path }}/../openhtmltopdf__html_CSS_Selectors_I_is.html.png" alt="openhtmltopdf Preview" />
        <p>
            <a href="/html2pdf/{{ page.path }}/../openhtmltopdf__html_CSS_Selectors_I_is.html.pdf" target="_blank">📕 openhtmltopdf Output</a>
        </p>
    </div>
    <div>
        <h4>pdfHTML (iText 7 add-on)</h4>
        <img src="/{{ page.path }}/../itextpdfhtml__html_CSS_Selectors_I_is.html.png" alt="pdfHTML (iText 7 add-on) Preview" />
        <p>
            <a href="/html2pdf/{{ page.path }}/../itextpdfhtml__html_CSS_Selectors_I_is.html.pdf" target="_blank">📕 pdfHTML (iText 7 add-on) Output</a>
        </p>
    </div>
    <div>
        <h4>Flying Saucer</h4>
        <img src="/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_I_is.html.png" alt="Flying Saucer Preview" />
        <p>
            <a href="/html2pdf/{{ page.path }}/../flyingsaucer__html_CSS_Selectors_I_is.html.pdf" target="_blank">📕 Flying Saucer Output</a>
        </p>
    </div>
</div>
